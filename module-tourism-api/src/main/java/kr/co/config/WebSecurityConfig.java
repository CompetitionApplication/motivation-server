...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        String[] permitUrl = {"/app/tour/files/**","/api/v1/admin/login/**","/api/v1/external/**", "/api/v1/app/user/login/**", "/api/v1/app/user/join/**","/swagger-ui/**", "/swagger-resources/**", "/v3/api-docs/**"};
