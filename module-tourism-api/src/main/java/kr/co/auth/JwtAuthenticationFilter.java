        ...
        if (userId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtUtil.validateToken(jwt, userDetails)) {
                ...
                if (userId.contains("admin")) {
                    AdminUser adminUser = adminUserRepository.findByAdminUserEmail(userId).orElse(null);
                    ServiceAdminUser serviceAdminUser = new ServiceAdminUser(adminUser);
                    UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken =
                            new UsernamePasswordAuthenticationToken(serviceAdminUser, null, null);
